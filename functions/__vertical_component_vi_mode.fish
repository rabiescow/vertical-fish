function __vertical_component_vi_mode
  ...
  __vertical_util_set vertical_vi_mode_icon_color        "#9a9a9a" \
                                    --background "#232323"
  __vertical_util_set vertical_vi_mode_sym_insert        "Insert"
  __vertical_util_set vertical_vi_mode_sym_insert_color  "#9ADE9A" \
                                    --bold --background "#232323"
  __vertical_util_set vertical_vi_mode_sym_normal        "Normal"
  __vertical_util_set vertical_vi_mode_sym_normal_color  "#9A9ADE" \
                                    --bold --background "#232323"
  __vertical_util_set vertical_vi_mode_sym_replace_one   "Replace"
  __vertical_util_set vertical_vi_mode_sym_replace_color "#DE9A9A" \
                                    --bold --background "#232323"
  __vertical_util_set vertical_vi_mode_sym_visual        "Visual"
  ...
  switch $fish_bind_mode
    ...
    case replace_one;
      set_color $vertical_vi_mode_sym_replace_one_color
